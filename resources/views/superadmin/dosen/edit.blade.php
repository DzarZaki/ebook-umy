<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-kabut-800">Ubah Akun Dosen</h2>
    </x-slot>
                    ...
                    <div class="mt-4">
                        <label class="inline-flex items-center gap-2">
                            ...
                            <input type="checkbox" name="is_active" value="1"
                                   class="rounded border-kabut-300 text-jingga-600 focus:ring-jingga-500"
                                   @checked(old('is_active', $dosen->is_active))>
                            <span class="text-sm text-kabut-700">Akun aktif</span>
                        </label>
                    </div>

                    <div class="mt-6 border-t border-kabut-200 pt-6">
                        <p class="text-sm text-kabut-500">Kosongkan bagian di bawah bila tidak ingin mengganti kata sandi.</p>
